...
<html lang="ja" class="js not-logged-in client-root js-focus-visible sDN5V">
                  ...
                  <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm                                                              kEKum                                                ">
                    <div class="-MzZI">
                      <div class="_9GP1n   "><label class="f0n8F "><span class="_9nyy2"></span><input aria-label="Phone number, username, or email" aria-required="true" autocapitalize="off" autocorrect="off" maxlength="75" name="email" id="email"
                            type="text" class="_2hvTZ pexuQ zyHYP" value="" placeholder="電話番号、ユーザーネーム、メールアドレス"></label>
                        <div class="i24fI"></div>
                      </div>
                    </div>
                    <div class="-MzZI">
                      <div class="_9GP1n   "><label class="f0n8F "><span class="_9nyy2"></span><input aria-label="Password" aria-required="true" autocapitalize="off" autocorrect="off" name="password" id="password" type="password" class="_2hvTZ pexuQ zyHYP"
                            value="" placeholder="パスワード"></label>
                        <div class="i24fI"></div>
                      </div>
                    </div>
                    <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    "><button
                        class="sqdOP  L3NKy   y3zKF     " type="submit" id="btn" name="btn">
                        <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm                                                                                                              ">ログイン</div>
                      </button></div>
                    <div class="K-1uj Z7p_S">
                      <div class="s311c"></div>
                      <div class="_0tv-g">または</div>
                      <div class="s311c"></div>
                    </div>
                    <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    "><button
                        class="sqdOP yWX7d    y3zKF     " type="button"><span class=" coreSpriteFacebookIcon AeB99"></span><span class="KPnG0">FaceBookでログイン</span></button></div>
                  </div><a class="_2Lks6" href="#" tabindex="0">パスワードを忘れた場合</a>
                </form>
              </div>
            </div>
            <div class="gr27e">
              <div class="_7UhW9   xLCgt      MMzan   _0PwGv         uL8Hv         ">
                <p class="izU2O ">アカウントを持っていない場合 <a href="#" tabindex="0"><span class="_7UhW9   xLCgt       qyrsm      gtFbE      se6yk        ">登録する</span></a></p>
              </div>
            </div>
            <div class="APQi1">
              <p class="b_nGN">アプリを入手</p>
        ...
        <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm               KokQV                                                                                               ">
          <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm                                                              kEKum                                                ">
            <div class="                     Igw0E     IwRSH        YBx95   ybXk5    _4EzTm  YlhBV                                                                                                            ">
              ...
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#"
                  rel="nofollow noopener noreferrer">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ブログ</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">求人</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#"
                  rel="nofollow noopener noreferrer">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ヘルプ</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">API</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">プライバシー</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">利用規約</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">トップアカウント</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ハッシュタグ</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">所在地</div>
                </a></div>
            </div>
            <div class="                     Igw0E     IwRSH        YBx95   ybXk5    _4EzTm  YlhBV                                                                                                            ">
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ビューティー</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ダンス &amp; パフォーマンス</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">フィットネス</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">フード &amp; ドリンク</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ホーム &amp; ガーデン</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">音楽</div>
                </a></div>
              <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm     _22l1                 soMvl                  JI_ht                                                                      "><a href="#">
                  <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">ビジュアルアート</div>
                </a></div>
            </div>
          </div>
          <div class="                     Igw0E     IwRSH        YBx95   ybXk5    _4EzTm     _22l1                                                      _49XvD                                                   ">
            <div class="_7UhW9  PIoXz       MMzan  KV-D4          uL8Hv         "><span class="_3G4x7   RFk-t bwz9f ">
                ...
                </div><select aria-label="言語を切り替える" class="hztqj">
                  <option value="ja">日本語</option>
                </select>
              </span></div>
            <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm                        _5VUwz                                                                                      ">
              <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">© 2023 Instagram from Meta</div>
            </div>
          </div>
        </div>
      </footer>
